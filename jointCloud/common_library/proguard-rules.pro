...
-keep class com.winds.libsly.** {*;}
-keep class com.example.liangmutian.mypicker.** {*;}
-keep class com.umeng.message.lib.** {*;}
-keep class teprinciple.updateapputils.** {*;}
...
#-keep public class com.unc.project.unccommonproject.kotlin.model.** {
#    public void set*(***);
#    public *** get*();
#    public *** is*();
#}
